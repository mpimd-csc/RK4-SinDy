...
learningrates = 1e-2*np.asarray([50., 25., 10., 10., 5., 5., 1.,1.])
...
for i in range(len(timesteps)):
    ...
    with closing(Tee(Params.save_model_path + "Linear2D_DiscoveredModels.log", "a+", channel="stdout")) as outputstream:
    ...
    Coeffs, loss_track = learning_sparse_model(funs_dictionary, Coeffs, dataloaders, Params,quite = True)
    ...
    if Params.tikz_save:
        tikzplotlib.save(Params.save_model_path + "Linear2D_timestep_{}.tex".format(Params.timestep))
    plt.show()
    fig.savefig(Params.save_model_path + "Linear2D_timestep_{}.pdf".format(Params.timestep), bbox_inches = 'tight',pad_inches = 0)
    ...
    if Params.tikz_save:
        tikzplotlib.save(Params.save_model_path + "Linear2D_3Dplot_timestep_{}.tex".format(Params.timestep))
    plt.show()
    fig.savefig(Params.save_model_path + "Linear2D_3Dplot_timestep_{}.pdf".format(Params.timestep), bbox_inches = 'tight',pad_inches = 0)
    ...
    if Params.tikz_save:
        tikzplotlib.save(Params.save_model_path + "Linear2D_23Dplot_timestep_{}.tex".format(Params.timestep))
    plt.show()
    fig.savefig(Params.save_model_path + "Linear2D_23Dplot_timestep_{}.pdf".format(Params.timestep), bbox_inches = 'tight',pad_inches = 0)
